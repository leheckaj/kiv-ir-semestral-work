...
public class Processor implements java.io.Serializable{
    ...
    /**
     * Připraví preprocessing pro svou práci
     */
    ...
    public void init(){
        Reader fReader = null;
        try {
            fReader = new InputStreamReader(new FileInputStream(Constants.INPUT_DATA_CSV_FILE), StandardCharsets.UTF_8);
        } catch (FileNotFoundException e) {
            System.out.println("Prosím vložte vedle JARu tento soubor: " + Constants.INPUT_DATA_CSV_FILE);
            System.exit(0);
        }
